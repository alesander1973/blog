...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Title -->
            <h1 class="mt-4" style="font-family: ariel;">Old city Jerusalem</h1>
            ...
            <!-- Preview Image -->
            <img id="ex8" class="img-fluid rounded" src="image/wall.jpg" style="width: 900px; height: 300px;" alt="wall">
            <hr>
